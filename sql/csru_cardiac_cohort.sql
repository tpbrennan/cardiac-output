--create table csru_cohort as

-- get CSRU admissions
with population as (
  select distinct subject_id, icustay_id, hadm_id, icustay_intime
...
select count(*) from final_cohort;
...
--select count(distinct icustay_id) from final_cohort_detail; --9,830 icu adm
